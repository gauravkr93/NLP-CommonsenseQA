...
# Adapted from https://github.com/ari9dam/McQueen/blob/master/scripts/Physical/insert_text_to_elasticsearch.py
...
ELASTIC_SEARCH_URL = 'http://localhost:9200/cqa_kb2/sentence/_bulk'
DOCUMENTS_PER_POST = 50000
...
def lines_to_sentences(line_stream):
  for line in line_stream:
    line_cleaned = line.split(';')[0]  # for webchild, drop examples
    line_cleaned = re.sub(r"[^a-zA-Z0-9\.,']", " ", line_cleaned.encode('ascii', errors='ignore').decode()).strip()
